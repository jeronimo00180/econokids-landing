  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <div className="relative">
        {/* Tablet frame */}
        <div className="bg-gray-800 rounded-4xl p-3 shadow-2xl">
                ...
                <div key={index} className="flex-[0_0_100%] min-w-0">
                  ...
                  >
                    <Image
                      ...
                      priority={index === 0}
                    />
                    {/* Zoom hint - avec texte pour accessibilité */}
        ...
        {showArrows && slides.length > 1 && (
          <>
            <button
              onClick={scrollPrev}
              className="absolute -left-4 md:-left-6 top-1/2 -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 rounded-full bg-white shadow-lg flex items-center justify-center hover:bg-gray-50 transition-colors z-10 border border-gray-200"
            ...
            <button
              onClick={scrollNext}
              className="absolute -right-4 md:-right-6 top-1/2 -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 rounded-full bg-white shadow-lg flex items-center justify-center hover:bg-gray-50 transition-colors z-10 border border-gray-200"
